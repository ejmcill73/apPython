...
def calculate_and_print (num1,num2,num3)
sum_of_first_two= num1 + num2 
result= sum_of_first_two / num3 
...
def elavator_function(elavator_floor)
    if : elavator_floor = 203
print("they_are_going_to_the_gym")
elif elavator_floor = g 
print("going_to_lobby")
...
largest_number = max(100,230,40,39403,19)
print(39403,230)
...
user_input1 = ("Enter the initial password:")
if user_input1== initial_password:
    print("Enter second password")
    second_password= "3039"
    if user_input1== second_password
    print("Enter the building")
    wrong_password = "2006"
    if user_input1== wrong_password
    print("Access denied")
...
answer9= #what it means to call your function is to give the computer an instruction 
#we call functions to group the code together 
